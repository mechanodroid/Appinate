	...
	public class ResultsActivity : Activity
	{
		protected override void OnCreate (Bundle bundle)
		{
			...
			button1.Click += delegate {
				var uri = Android.Net.Uri.Parse (MainActivity.gameDataList[0].market_url);
			...
			button2.Click += delegate {
				var uri = Android.Net.Uri.Parse (MainActivity.gameDataList[1].market_url);
				var intent = new Intent (Intent.ActionView, uri);
				StartActivity (intent);
			};
			...
			button3.Click += delegate {
				var uri = Android.Net.Uri.Parse (MainActivity.gameDataList[2].market_url);
				var intent = new Intent (Intent.ActionView, uri);
				StartActivity (intent);
			};
			...
			button4.Click += delegate {
				var uri = Android.Net.Uri.Parse (MainActivity.gameDataList[3].market_url);
				var intent = new Intent (Intent.ActionView, uri);
				StartActivity (intent);
			};
			...
			button5.Click += delegate {
				var uri = Android.Net.Uri.Parse (MainActivity.gameDataList[4].market_url);
				var intent = new Intent (Intent.ActionView, uri);
				StartActivity (intent);
			};
